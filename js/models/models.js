...
export default {
  ...
  earthAxis: function (params) {
    ...
    let RADIUS = simple ? 700000 * c.SF : 200000 * c.SF;
    let HEAD_RADIUS = simple ? 3 : 2;
    ...
    let arrowHeadGeo = new THREE.CylinderGeometry(0, RADIUS * HEAD_RADIUS, HEIGHT * 0.05, 32);
  ...
  viewAxis: function () {
    let HEIGHT = 30000000 * c.SF;
    let RADIUS = 700000 * c.SF;
    let geometry = new THREE.CylinderGeometry(RADIUS, RADIUS, HEIGHT, 32);
    ...
    let arrowHeadGeo = new THREE.CylinderGeometry(RADIUS * 3, 0, HEIGHT * 0.05, 32);
    let arrowHeadMesh = new THREE.Mesh(arrowHeadGeo, material);
    arrowHeadMesh.position.y = -HEIGHT * 0.5;
    mesh.add(arrowHeadMesh);
